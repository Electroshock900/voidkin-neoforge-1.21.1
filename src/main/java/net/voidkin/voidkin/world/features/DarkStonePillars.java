package net.voidkin.voidkin.world.features;
...
public class DarkStonePillars extends Feature<NoneFeatureConfiguration> {
    public DarkStonePillars(Codec<NoneFeatureConfiguration> pCodec) {
        super(pCodec);
    }
