...
import net.voidkin.voidkin.menu.Pedestal2Menu;
import net.voidkin.voidkin.menu.PedestalMenu;

public class Pedestal2Screen extends AbstractContainerScreen<Pedestal2Menu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Voidkin.MODID, "textures/gui/altar_gui2.png");

    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Voidkin.MODID, "textures/gui/crystallizer/arrow_progress.png");

    private static final ResourceLocation CRYSTAL_TEXTURE =
            ResourceLocation.parse("textures/block/amethyst_cluster.png");

    public Pedestal2Screen(Pedestal2Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        RenderSystem.setShaderColor(0.7F, 0.3F, 0.3F, 1.0F);
