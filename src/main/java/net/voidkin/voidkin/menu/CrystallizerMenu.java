...
public class CrystallizerMenu extends AbstractContainerMenu {
    ...
    public CrystallizerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        //this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(blockEntity -> {
                    this.addSlot(new SlotItemHandler(blockEntity.inv, 0, 8, 62));
                    this.addSlot(new SlotItemHandler(blockEntity.inv, 1, 54, 34));
                    this.addSlot(new SlotItemHandler(blockEntity.inv, 2, 104, 34));
                    this.addSlot(new SlotItemHandler(blockEntity.inv, 3, 152, 62));
