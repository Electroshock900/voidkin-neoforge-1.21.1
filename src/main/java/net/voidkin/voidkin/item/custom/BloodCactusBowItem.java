...
public class BloodCactusBowItem extends BowItem {
    public static final Predicate<ItemStack> ARROW_ONLY = (arrow) -> arrow.is(ModItems.BLOOD_SPINE.asItem());
    public static final int MAX_DRAW_DURATION = 20;
    public static final int DEFAULT_RANGE = 20;

    public BloodCactusBowItem(Properties properties) {
            ...
            if (!itemstack.isEmpty()) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    if (level instanceof ServerLevel serverlevel /**&& !list.isEmpty()**/) {
                            ...
                            this.shoot(serverlevel, player, player.getUsedItemHand(), stack, list, f * 3.0F, 1.0F, f == 0.75F, null);
    ...
    protected Projectile createProjectile(Level level, LivingEntity shooter, ItemStack weapon, ItemStack ammo, boolean isCrit) {
        ...
        Blood_Spine_Item var10000;
        if (var8 instanceof Blood_Spine_Item arrowitem1) {
            var10000 = arrowitem1;
        } else {
            var10000 = (Blood_Spine_Item) ModItems.BLOOD_SPINE.asItem();
        }

        Blood_Spine_Item arrowitem = var10000;
    ...
    @Override
       ...
       public AbstractArrow customArrow (AbstractArrow arrow){
           return ModEntities.BLOODSPINE.get().create(arrow.level());
       }
