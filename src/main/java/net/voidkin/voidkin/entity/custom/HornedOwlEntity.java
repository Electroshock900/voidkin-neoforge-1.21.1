...
public class HornedOwlEntity extends Animal implements FlyingAnimal {

    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(HornedOwlEntity.class, EntityDataSerializers.INT);
    ...
    public HornedOwlEntity(EntityType<? extends Animal> pType, Level level) {
        super(pType, level);
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mob) {
        return ModEntities.HORNED_OWL.get().create(level);
    }
