package net.voidkin.voidkin.entity.component;
...
public class XionPortalAttachment {
        ...
        public void tick(Player player) {
            if (this.isInsidePortal()) {
                ...
                if (!player.isInWall()) {
                    ...
                    if (!(player.level().getBlockState(pos).getBlock() instanceof XionPortalBlock) && !(player.level().getBlockState(pos.below()).getBlock() instanceof XionPortalBlock)) {
