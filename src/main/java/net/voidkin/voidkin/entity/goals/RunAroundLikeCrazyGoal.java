...
public class RunAroundLikeCrazyGoal extends Goal {
    ...
    public RunAroundLikeCrazyGoal(AbstractCheeseHorse horse, double speedModifier) {
        this.horse = horse;
    ...
    public void tick() {
        if (!this.horse.isTamed() && this.horse.getRandom().nextInt(this.adjustedTickDelay(50)) == 0) {
            ...
            if (entity instanceof Player) {
                ...
                if (j > 0 && this.horse.getRandom().nextInt(j) < i && !EventHooks.onAnimalTame(this.horse, (Player)entity)) {
