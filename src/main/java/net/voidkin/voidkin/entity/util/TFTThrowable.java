...
public class TFTThrowable extends ThrowableProjectile /**implements ITFProjectile**/ {

    public TFTThrowable(EntityType<? extends ThrowableProjectile> type, Level worldIn) {
        super(type, worldIn);
    }

    public TFTThrowable(EntityType<? extends ThrowableProjectile> type, Level worldIn, double x, double y, double z) {
        super(type, x, y, z, worldIn);
    }

    public TFTThrowable(EntityType<? extends ThrowableProjectile> type, Level worldIn, LivingEntity throwerIn) {
