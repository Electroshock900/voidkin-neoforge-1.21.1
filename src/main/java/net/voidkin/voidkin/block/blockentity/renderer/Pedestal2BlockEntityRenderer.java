...
public class Pedestal2BlockEntityRenderer implements BlockEntityRenderer<Pedestal2BlockEntity> {
    public Pedestal2BlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(Pedestal2BlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        /**if (!stack.isEmpty()) {
            double tick2 = pBlockEntity.getLevel().getGameTime() + pPartialTick;
            pPoseStack.pushPose();
            pPoseStack.translate(0.5f, 1.2f, 0.5f);
            pPoseStack.scale(
                    0.65f,0.65f,0.65f
