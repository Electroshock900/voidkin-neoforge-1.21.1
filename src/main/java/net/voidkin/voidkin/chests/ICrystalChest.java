...
public interface ICrystalChest {
    ...
    default void sortTopStacks() {
        ...
        NonNullList<ItemStack> tempCopy = NonNullList.<ItemStack>withSize(ModChestsTypes.CRYSTAL.size, ItemStack.EMPTY);
        ...
        mainLoop:
        for (int i = 0; i < ModChestsTypes.CRYSTAL.size; i++) {
