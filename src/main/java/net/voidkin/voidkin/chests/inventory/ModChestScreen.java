package net.voidkin.voidkin.chests.inventory;
...
import net.voidkin.voidkin.chests.ModChestMenu;
...
public class ModChestScreen extends AbstractContainerScreen<ModChestMenu> implements MenuAccess<ModChestMenu> {
    ...
    public ModChestScreen(ModChestMenu ironChestMenu, Inventory playerInventory, Component title) {
